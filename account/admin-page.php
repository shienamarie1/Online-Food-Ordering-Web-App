...
<body>
  ...
  <div id="main">
    ...
    <div class="wrapper">
      ...
      id="formValidate" 
      method="post" 
      action="routers/menu-router.php"
      enctype="multipart/form-data"
      novalidate="novalidate">
            <div class="row">
              <div class="col s12 m4 l3">
                <h4 class="breadcrumbs-title">Edit Inventory Items</h4>
              </div>
              <div>
				...
				while($row = mysqli_fetch_array($result))
        {
            ...
            echo '<td>
                    <div class="input-field col s12">
                        <label for="'.$row["id"].'_name" class="active">Name</label>
                        <input value="'.$row["name"].'" 
                              id="'.$row["id"].'_name" 
                              name="'.$row["id"].'_name" 
                              type="text" 
                              data-error=".errorTxt'.$row["id"].'">
            ...
            echo '<td>
                    <div class="input-field col s12">
                        <label for="'.$row["id"].'_price" class="active">Price</label>
            ...
            echo '<td>
                    <div class="input-field col s12">
                        <label for="'.$row["id"].'_stock" class="active">Stock</label>
            ...
            if(!empty($row['image'])){
                echo '<img src="data:image/jpeg;base64,'.base64_encode($row['image']).'" 
                          width="80" 
                          height="80"
                          style="border-radius:5px; object-fit:cover; display:block; margin-bottom:10px;">';
            } else {
                echo 'No Image<br><br>';
            }
		  ...
		  <form class="formValidate" id="formValidate1" method="post" action="routers/add-item.php" novalidate="novalidate" enctype="multipart/form-data">
            <div class="row">
              <div class="col s12 m4 l3">
                <h4 class="header">Add Inventory Item</h4>
              </div>
              <div>
<table>
                    <thead>
				...
				<?php
					...
					echo '<td><div class="input-field col s12 "><label for="stock" class="">Stock</label>';
                    echo '<input id="stock" name="stock" type="text" data-error=".errorTxt03"><div class="errorTxt03"></div></td>';
